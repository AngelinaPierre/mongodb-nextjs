...
export default function Home({ isConnected }) {
  return (
    <div className="container">
      ...
      <main>
        ...
        <div className="grid">
          ...
          <a href="https://github.com/vercel/next.js/tree/canary/examples" className='card'>
            <h3>Examples &rarr;</h3>
            <p>Discover and deploy boilerpate example Next.js projects.</p>
          </a>
          <a href="https://vercel.com/new?utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app" className='card'>
            <h3>Deploy &rarr;</h3>
            <p>
              Instantly deploy Next.js site to a public URL with Vercel.
            </p>
          </a>
        </div>
      </main>
      ...
      <footer>
        <a href="https://vercel.com?utm_source=create-next-app&utm_medium=default-template&utm-campaign=create-next-app" target='_blank' rel='noopener noreferrer'>
          Powered by{' '}
